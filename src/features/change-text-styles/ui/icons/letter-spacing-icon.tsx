...
export const LetterSpacingIcon = ({ fill }: { fill: string, }) => {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clip-path="url(#clip0_1_1572)">
        ...
        <path d="M1.5 13L2 13.5L2 12.5L1.5 13ZM1.5 13L14.5 13M14.5 13L14 12.5L14 13.5L14.5 13Z" stroke={fill} stroke-width="2" stroke-linecap="round"/>
      </g>
      <defs>
